class Ciudad{
    ...
    #procesarJSONEntrenos(data){
        ...
        articulo.append($("<p></p>").text("Temperatura media: " +  (temperaturaMediaDia1/3).toFixed(2) + " ºC"));
        articulo.append($("<p></p>").text("Lluvia media: " + (lluviaMediaDia1/3).toFixed(2) + " mm"));
        articulo.append($("<p></p>").text("Velocidad media del viento: " + (velocidadVientoMediaDia1/3).toFixed(2) + " km/h"));
        articulo.append($("<p></p>").text("Humedad relativa media: " + (humedadMediaDia1/3).toFixed(2) + " %"));
        ...
        articulo.append($("<p></p>").text("Temperatura media: " +  (temperaturaMediaDia2/2).toFixed(2) + " ºC"));
        articulo.append($("<p></p>").text("Lluvia media: " + (lluviaMediaDia2/2).toFixed(2) + " mm"));
        articulo.append($("<p></p>").text("Velocidad media del viento: " + (velocidadVientoMediaDia2/2).toFixed(2) + " km/h"));
        articulo.append($("<p></p>").text("Humedad relativa media: " + (humedadMediaDia2/2).toFixed(2) + " %"));
